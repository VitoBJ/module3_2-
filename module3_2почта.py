...
send_email("Привет, как дела?", "recipient@example.com", sender="custom.sender@example.com")
send_email("Привет, как дела?", "invalid-email")
send_email("Привет!", "sender@example.com", sender="sender@example.com")